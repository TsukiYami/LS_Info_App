namespace Entities.Entities {
    public class WeatherForecastDataEntity {
        public WeatherForecastDataEntity(int nId, string sCity, string sCountry, string sConditionText, float dMaxTempC, float dMinTempC, float dAvgTempC, DateOnly oForDate) {
            this.nId = nId;
            this.sCity = sCity;
        ...
        public WeatherForecastDataEntity(string sCondition, float dMaxtemp_c, float dMintemp_c, float dAvgtemp_c, DateOnly oForDate, string sCity = "Bremen", string sCountry = "Germany") {
            this.sCity = sCity;
            this.sCountry = sCountry;
        ...
        public DateOnly oForDate { get; set; }
